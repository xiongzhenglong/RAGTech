...
#
# NOTE: This script relies on a JSON output file generated by
# `demo_01_pdf_parsing.py` (which internally uses a `JsonReportProcessor`).
# Ensure that `demo_01_pdf_parsing.py` has been run successfully and its
# output JSON (e.g., "194000c9109c6fa628f1fed33b44ae4c2b8365f4.json")
# is placed in the "study/parsed_output/" directory for this script to function.
